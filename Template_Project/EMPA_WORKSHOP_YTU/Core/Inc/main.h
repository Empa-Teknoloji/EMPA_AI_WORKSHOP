...
#define INT1_ISM330_EXTI_IRQn EXTI6_IRQn
#define INT2_ISM330_Pin GPIO_PIN_7
#define INT2_ISM330_GPIO_Port GPIOA
#define INT2_ISM330_EXTI_IRQn EXTI7_IRQn
#define LED2_Pin GPIO_PIN_1
#define LED2_GPIO_Port GPIOB
#define LED3_Pin GPIO_PIN_2
#define LED3_GPIO_Port GPIOB
#define SAI_CLK_Pin GPIO_PIN_10
#define SAI_CLK_GPIO_Port GPIOB
...
#define SAI_DOUT_Pin GPIO_PIN_10
#define SAI_DOUT_GPIO_Port GPIOA
