...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, AT_TX_Pin|AT_RX_Pin);
...
/* SAI1 */
  ...
  */
    ...
    PB9     ------> SAI1_FS_A
    */
    GPIO_InitStruct.Pin = SAI_CLK_Pin|GPIO_PIN_9;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    GPIO_InitStruct.Pin = SAI_DOUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF13_SAI1;
    HAL_GPIO_Init(SAI_DOUT_GPIO_Port, &GPIO_InitStruct);
    ...
    __HAL_LINKDMA(hsai, hdmarx, handle_GPDMA1_Channel14);
...
/* SAI1 */
    ...
    PB9     ------> SAI1_FS_A
    */
    HAL_GPIO_DeInit(GPIOB, SAI_CLK_Pin|GPIO_PIN_9);

    HAL_GPIO_DeInit(SAI_DOUT_GPIO_Port, SAI_DOUT_Pin);
