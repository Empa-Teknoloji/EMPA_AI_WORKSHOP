...
MQTT_Config mqttConfig = {
    ...
    .clientID = "",
    .username = "empaelectronics",
    .mqttPassword = "Empa123456+",
    .keepAlive = 300,
    .cleanSession = CLS_1,
    .qos = QOS_0,
    .retain = RTN_0,
    .brokerAddress = "cf25e86f3af44eda80893f20d071f69c.s1.eu.hivemq.cloud",
    .reconnect = 0
};
	...
	while(ENABLE_ESP32)
	{
		...
		case STATE_MQTT_COLLECT :
			...
			if (MQTT_Init(&mqttConfig) == FUNC_SUCCESSFUL) {
				if (Wifi_MqttSubInit(mqttPacketBuffer, "EMPA", QOS_0)
						== FUNC_OK) {
					cntTryFunc = 0;
			...
			case STATE_MQTT_PUB_TX_MSG :
				  ...
				  Wifi_MqttPubRaw2(mqttPacketBuffer, TOPIC_PUB_DATA, strlen(dizi), dizi, QOS_0, RTN_0, POLLING_MODE);
